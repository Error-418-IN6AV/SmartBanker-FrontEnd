  ...
  const addClient = async () => {
    try {
      let client = {
        ...
        nocuenta: document.getElementById('inputNoCuent').value,
      ...
      <main>
        <div className="left binding color">
          ...
          <div className='text-center'>
            <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Client</button>
          </div>
        </div>
        <div className="row g-0 justify-content-center">
          {
            client.map(({ _id, name, surname, username, nocuenta, location, phone, email, namework, monthlyincome, balance, role }, i) => {
              return (
                <CardClient
                  _id={_id}
                  key={i}
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="row">
              ...
              <div className="col-md-6 mb-4">
                <div className="form-floating">
                  <input type="number" id="inputNoCuent" name='number' className="form-control" placeholder='number' />
                  <label className="form-label" htmlFor="inputNoCuent">Account Number</label>
                </div>
              </div>
            </div>
