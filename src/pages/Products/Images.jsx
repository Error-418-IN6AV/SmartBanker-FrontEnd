...
export const Images = () => {
	...
	return (
		<>
			...
			<div className="modal-body" type='file'>
				<h2 className="modal-title">Upload a file {products.name}</h2>
			...
			<div className="modal-footer">
				<button className="btn-secondary" onClick={() => navigate('/dashboard/productsAndServices')}>Back</button>
